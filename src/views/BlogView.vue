      ...
      <div>
        ...
        <div v-if="uploadStatus.message" class="mb-4">
          <div :class="[
            ...
            <div class="flex items-center">
              <svg v-if="uploadStatus.isError" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none"
            ...
            <div v-if="uploadStatus.loading && batchUploadProgress.total > 0" class="mt-2">
              <div class="h-2 bg-gray-300 dark:bg-gray-600 rounded-full overflow-hidden">
                <div class="h-full bg-github-blue dark:bg-blue-500" :style="`width: ${(batchUploadProgress.current / batchUploadProgress.total) *
                  100
                  }%`"></div>
              </div>
        ...
        <div v-if="showUploadForm"
          ...
          <div class="space-y-4">
              ...
              <div class="flex items-center">
                <label for="markdown-file"
                  ...
                  <div v-if="!uploadedFile" class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-github-gray mb-2" fill="none"
                      viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div>
              ...
              <div class="mt-3 flex flex-wrap gap-2" v-if="blogStore.categories.length">
                <span class="text-xs">现有分类:</span>
                <button v-for="category in blogStore.categories" :key="category" @click="newCategory = category"
            ...
            <div>
              ...
              <input type="text" id="tags" v-model="newTags" placeholder="标签1, 标签2, 标签3"
                class="w-full p-2 border border-[var(--color-border)] rounded-md bg-[var(--color-bg-primary)]" />
              <div class="mt-3 flex flex-wrap gap-2" v-if="blogStore.tags.length">
                <span class="text-xs">现有标签:</span>
                <button v-for="tag in blogStore.tags" :key="tag" @click="
                  newTags
        ...
        <div v-if="showBatchUploadForm"
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="flex items-center">
                <label for="markdown-files"
                  ...
                  @dragover="handleDragOver" @dragleave="handleDragLeave" @drop="handleBatchDrop">
                  ...
                  <div v-else class="flex flex-col items-center text-github-green">
                    ...
                    <button @click.stop="batchFiles = []" class="text-xs text-red-500 mt-1 hover:underline">
                      清除选择
                    </button>
                  </div>
                </label>
            ...
            <div>
              ...
              <div class="mt-3 flex flex-wrap gap-2" v-if="blogStore.categories.length">
                <span class="text-xs">现有分类:</span>
                <button v-for="category in blogStore.categories" :key="category" @click="batchCategory = category"
                  class="px-2 py-1 text-xs rounded-full bg-green-100 text-github-green dark:bg-green-900 dark:text-green-300 hover:bg-green-200 dark:hover:bg-green-800 transition-colors">
                  {{ category }}
                </button>
              </div>
            ...
            <div class="flex justify-end gap-2 mt-6">
              ...
              <button @click="handleBatchUpload" :disabled="batchFiles.length === 0 || uploadStatus.loading" :class="[
                'px-4 py-2 rounded-md text-white',
        ...
        <div class="mb-6 flex flex-col space-y-4">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <button v-if="categoryFilter || tagFilter || searchQuery" @click="
              categoryFilter = '';
            tagFilter = '';
            searchQuery = '';
            "
