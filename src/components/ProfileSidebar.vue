      ...
      <div v-if="!isCollapsed"
        ...
        <div class="border-t border-[var(--color-border)] px-4 py-3">
          ...
          <div class="flex items-center text-[var(--color-text-secondary)] text-sm mb-2" v-if="profile.website">
            ...
            <a :href="profile.website" target="_blank" rel="noopener noreferrer"
              class="text-[var(--color-link)] hover:underline">{{ profile.website }}</a>
          </div>
        ...
        <div class="border-t border-[var(--color-border)] px-4 py-3">
          <router-link to="/admin" target="_blank"
            class="flex items-center text-[var(--color-text-secondary)] hover:text-[var(--color-link)] transition-colors">
